...
public class Exams extends AppCompatActivity
    ...
    Hashtable<Integer, String>  examidtoidList;
    TextView tvInfo;
    ...
    void getExam(String id) {

       /* Intent intent = new Intent(this, ExamDetail.class);
    ...
    public void onItemClick(AdapterView<?> parent, View view,
        ...
        Log.d(LOG_TAG, "itemClick: position = " + position + ", id = "
                + id + "; ExamID: " + examidtoidList.get((int)id));
        //getExam(examidtoidList.get((int)id));
    }
}
